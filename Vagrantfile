...
Vagrant.configure(2) do |config|
  ...
  config.vm.define "inetRouter" do |inetRouter|
    ...
    inetRouter.vm.network "private_network", ip: "", virtualbox__intnet: "router-net"
    #management network
    inetRouter.vm.network "private_network", ip: "10.10.11.1"
  ...
  config.vm.define "centralRouter" do |centralRouter|
    ...
    centralRouter.vm.network "private_network", ip: "", virtualbox__intnet: "router-net"
    centralRouter.vm.network "private_network", ip: "192.168.5.1", virtualbox__intnet: "test-lan"
    #management network
    centralRouter.vm.network "private_network", ip: "10.10.11.2"
    centralRouter.vm.hostname = "centralRouter"
  end

  config.vm.define "testServer1" do |testServer1|
    testServer1.vm.network "private_network", ip: "192.168.5.2", virtualbox__intnet: "test-lan"
    #management network
    testServer1.vm.network "private_network", ip: "10.10.11.3"
    testServer1.vm.hostname = "testServer1"
  end

  config.vm.define "testClient1" do |testClient1|
    testClient1.vm.network "private_network", ip: "192.168.5.3", virtualbox__intnet: "test-lan"
    #management network
    testClient1.vm.network "private_network", ip: "10.10.11.4"
    testClient1.vm.hostname = "testClient1"
  end

  config.vm.define "testServer2" do |testServer2|
    testServer2.vm.network "private_network", ip: "192.168.5.4", virtualbox__intnet: "test-lan"
    #management network
    testServer2.vm.network "private_network", ip: "10.10.11.5"
    testServer2.vm.hostname = "testServer2"
  end

  config.vm.define "testClient2" do |testClient2|
    testClient2.vm.network "private_network", ip: "192.168.5.5", virtualbox__intnet: "test-lan"
    #management network
    testClient2.vm.network "private_network", ip: "10.10.11.6"
